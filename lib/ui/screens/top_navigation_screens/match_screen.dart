...
import 'package:Hitchcake/data/db/entity/match.dart';
import 'package:Hitchcake/data/db/entity/swipe.dart';
...
import 'package:Hitchcake/ui/widgets/swipe_card.dart';
...
class _MatchScreenState extends State<MatchScreen> {
  ...
  Future<AppUser?> loadPerson(String myUserId) async {
    if (_ignoreSwipeIds.isEmpty) {
      ...
      for (var swipeDoc in swipes.docs) {
        Swipe swipe = Swipe.fromSnapshot(swipeDoc);
    ...
    if (isLiked == true) {
      if (await isMatch(myUser, otherUser) == true) {
        ...
        final Map<String, dynamic> args = {
          'message': null, // Change `null` to whatever value you intend to pass
        };
        Navigator.pushNamed(context, MatchedScreen.id, arguments: args);
                ...
                return CustomModalProgressHUD(
                  ...
                  child: (userSnapshot.hasData)
                      ? FutureBuilder<AppUser?>(
                          future: userSnapshot.data?.id != null
                              ? loadPerson(userSnapshot.data!.id)
                              : null,
